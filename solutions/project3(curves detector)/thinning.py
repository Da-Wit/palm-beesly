# This file is created to feature extracting
# thinned lines by thinning algorithm.
...
def main(img_param, min_grayscale, max_grayscale, min_line_length, max_line_distance=3, number_of_lines_to_leave=10,
    ...
    horizontal_img = horizontal_lines.poly(horizontal_img)
    vertical_img = vertical_lines.poly(vertical_img)
